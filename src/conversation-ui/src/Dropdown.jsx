...
function Dropdown({ options, disabled, onChange, selected, defaultTitle }) {
  ...
  return (
    <select className="dropdown" disabled={disabled} onChange={onChangeHandler} defaultValue={selected ? selected : defaultTitleKey}>
      {!options && <option selected disabled={true}>No options</option>}
